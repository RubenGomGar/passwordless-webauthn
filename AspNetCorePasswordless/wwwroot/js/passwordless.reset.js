...
async function handleRegisterSubmit(event) {
    ...
    try {
        registerNewCredential(newCredential, code, username);
...
async function registerNewCredential(newCredential, code, username) {
...
async function registerCredentialWithServer(formData) {
    let response = await fetch(getFolder() + '/pwmakeResetCredential', {
        method: 'POST', // or 'PUT'
